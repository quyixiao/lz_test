...
public class Test1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        writeTrashFile(repository, "a/content", "1\n2\n3xxxxxxxxxxxx3333333333222ququququququququoidsoidios2");
        System.out.println("xxxxxxx");
        git.add().addFilepattern("a/content").call();
        System.out.println("yyyyyyyyyyyyy");
        RevCommit first = git.commit().setMessage("addedxxxxxxxx 1").call();
        ...
        MergeStrategy strategy = MergeStrategy.RESOLVE;
